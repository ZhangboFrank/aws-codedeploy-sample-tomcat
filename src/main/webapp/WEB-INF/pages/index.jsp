...
<head>
    ...
    <title>Bespoke Suits for Dogs! (A sample app for CodeDeploy) - version 2</title>
...
<body role="document">
  <nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#">CodePipeline - v2 - Bespoke Suits for Dogs</a>
      </div>
  ...
  <div class="container theme-showcase" role="main">
    ...
    <% } %>
    <div class="jumbotron">
      <h1>CodePipeline - demo - Bespoke Suits for Dogs</h1>
